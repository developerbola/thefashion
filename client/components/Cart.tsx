...
const Cart = () => {
  ...
  const total = cart.reduce(
    (acc: number, item: CartProductType) => acc + item.price * item.quantity,
    0
  );
                  ...
                  >
                    ...
                    <div className="h-[60px] flex flex-col justify-between items-end">
                      ...
                      >
                        <Button
                          variant="ghost"
                          className="size-6 rounded-none text-neutral-400 hover:text-neutral-400 hover:bg-neutral-100/50"
